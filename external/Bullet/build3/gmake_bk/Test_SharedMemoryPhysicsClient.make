...
ifeq ($(config),release64)
  ...
  LIBS      += -lBullet3Common_gmake_x64_release -lLinearMath_gmake_x64_release -lBulletFileLoader
  LDDEPS    += ../../bin/libBullet3Common_gmake_x64_release.so ../../bin/libLinearMath_gmake_x64_release.so
...
ifeq ($(config),debug64)
  ...
  RESFLAGS  += $(DEFINES) $(INCLUDES) 
  LIBS      += -lBullet3Common_gmake_x64_debug -lLinearMath_gmake_x64_debug -lBulletFileLoader
  LDDEPS    += ../../bin/libBullet3Common_gmake_x64_debug.so ../../bin/libLinearMath_gmake_x64_debug.so
  LINKCMD    = $(CXX) -o $(TARGET) $(OBJECTS) $(RESOURCES) $(ARCH) $(LIBS) $(LDFLAGS)
  define PREBUILDCMDS
  endef
  define PRELINKCMDS
