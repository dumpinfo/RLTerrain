...
class WeightedMemoryDataParameter;
...
class LayerParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional .caffe.WeightedMemoryDataParameter weighted_memory_data_param = 147;
  bool has_weighted_memory_data_param() const;
  void clear_weighted_memory_data_param();
  static const int kWeightedMemoryDataParamFieldNumber = 147;
  const ::caffe::WeightedMemoryDataParameter& weighted_memory_data_param() const;
  ::caffe::WeightedMemoryDataParameter* mutable_weighted_memory_data_param();
  ::caffe::WeightedMemoryDataParameter* release_weighted_memory_data_param();
  void set_allocated_weighted_memory_data_param(::caffe::WeightedMemoryDataParameter* weighted_memory_data_param);
 ...
 private:
  ...
  inline void set_has_weighted_memory_data_param();
  inline void clear_has_weighted_memory_data_param();
  ...
  ::caffe::WeightedMemoryDataParameter* weighted_memory_data_param_;
  int phase_;
  mutable int _cached_size_;
  friend void  protobuf_AddDesc_caffe_2eproto();
  friend void protobuf_AssignDesc_caffe_2eproto();
...
class WeightedMemoryDataParameter : public ::google::protobuf::Message {
 public:
  WeightedMemoryDataParameter();
  virtual ~WeightedMemoryDataParameter();

  WeightedMemoryDataParameter(const WeightedMemoryDataParameter& from);

  inline WeightedMemoryDataParameter& operator=(const WeightedMemoryDataParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const WeightedMemoryDataParameter& default_instance();

  void Swap(WeightedMemoryDataParameter* other);

  // implements Message ----------------------------------------------

  inline WeightedMemoryDataParameter* New() const { return New(NULL); }

  WeightedMemoryDataParameter* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const WeightedMemoryDataParameter& from);
  void MergeFrom(const WeightedMemoryDataParameter& from);
  void Clear();
  bool IsInitialized() const;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const;
  void InternalSwap(WeightedMemoryDataParameter* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return _internal_metadata_.arena();
  }
  ...
  ::google::protobuf::uint32 label_size() const;
  void set_label_size(::google::protobuf::uint32 value);

  // @@protoc_insertion_point(class_scope:caffe.WeightedMemoryDataParameter)
 private:
  inline void set_has_batch_size();
  inline void clear_has_batch_size();
  inline void set_has_channels();
  ...
  void InitAsDefaultInstance();
  static WeightedMemoryDataParameter* default_instance_;
};
// -------------------------------------------------------------------
...
// optional .caffe.WeightedMemoryDataParameter weighted_memory_data_param = 147;
inline bool LayerParameter::has_weighted_memory_data_param() const {
  return (_has_bits_[1] & 0x04000000u) != 0;
}
inline void LayerParameter::set_has_weighted_memory_data_param() {
  _has_bits_[1] |= 0x04000000u;
}
inline void LayerParameter::clear_has_weighted_memory_data_param() {
  _has_bits_[1] &= ~0x04000000u;
}
inline void LayerParameter::clear_weighted_memory_data_param() {
  if (weighted_memory_data_param_ != NULL) weighted_memory_data_param_->::caffe::WeightedMemoryDataParameter::Clear();
  clear_has_weighted_memory_data_param();
}
inline const ::caffe::WeightedMemoryDataParameter& LayerParameter::weighted_memory_data_param() const {
  // @@protoc_insertion_point(field_get:caffe.LayerParameter.weighted_memory_data_param)
  return weighted_memory_data_param_ != NULL ? *weighted_memory_data_param_ : *default_instance_->weighted_memory_data_param_;
}
inline ::caffe::WeightedMemoryDataParameter* LayerParameter::mutable_weighted_memory_data_param() {
  set_has_weighted_memory_data_param();
  if (weighted_memory_data_param_ == NULL) {
    weighted_memory_data_param_ = new ::caffe::WeightedMemoryDataParameter;
  }
  // @@protoc_insertion_point(field_mutable:caffe.LayerParameter.weighted_memory_data_param)
  return weighted_memory_data_param_;
}
inline ::caffe::WeightedMemoryDataParameter* LayerParameter::release_weighted_memory_data_param() {
  clear_has_weighted_memory_data_param();
  ::caffe::WeightedMemoryDataParameter* temp = weighted_memory_data_param_;
  weighted_memory_data_param_ = NULL;
  return temp;
}
inline void LayerParameter::set_allocated_weighted_memory_data_param(::caffe::WeightedMemoryDataParameter* weighted_memory_data_param) {
  delete weighted_memory_data_param_;
  weighted_memory_data_param_ = weighted_memory_data_param;
  if (weighted_memory_data_param) {
    set_has_weighted_memory_data_param();
  } else {
    clear_has_weighted_memory_data_param();
  }
  // @@protoc_insertion_point(field_set_allocated:caffe.LayerParameter.weighted_memory_data_param)
}
...
// optional uint32 batch_size = 1;
inline bool WeightedMemoryDataParameter::has_batch_size() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void WeightedMemoryDataParameter::set_has_batch_size() {
  _has_bits_[0] |= 0x00000001u;
}
inline void WeightedMemoryDataParameter::clear_has_batch_size() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void WeightedMemoryDataParameter::clear_batch_size() {
  batch_size_ = 0u;
  clear_has_batch_size();
}
inline ::google::protobuf::uint32 WeightedMemoryDataParameter::batch_size() const {
  // @@protoc_insertion_point(field_get:caffe.WeightedMemoryDataParameter.batch_size)
  return batch_size_;
}
inline void WeightedMemoryDataParameter::set_batch_size(::google::protobuf::uint32 value) {
  set_has_batch_size();
  batch_size_ = value;
  // @@protoc_insertion_point(field_set:caffe.WeightedMemoryDataParameter.batch_size)
}

// optional uint32 channels = 2;
inline bool WeightedMemoryDataParameter::has_channels() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void WeightedMemoryDataParameter::set_has_channels() {
  _has_bits_[0] |= 0x00000002u;
}
inline void WeightedMemoryDataParameter::clear_has_channels() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void WeightedMemoryDataParameter::clear_channels() {
  channels_ = 0u;
  clear_has_channels();
}
inline ::google::protobuf::uint32 WeightedMemoryDataParameter::channels() const {
  // @@protoc_insertion_point(field_get:caffe.WeightedMemoryDataParameter.channels)
  return channels_;
}
inline void WeightedMemoryDataParameter::set_channels(::google::protobuf::uint32 value) {
  set_has_channels();
  channels_ = value;
  // @@protoc_insertion_point(field_set:caffe.WeightedMemoryDataParameter.channels)
}

// optional uint32 height = 3;
inline bool WeightedMemoryDataParameter::has_height() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void WeightedMemoryDataParameter::set_has_height() {
  _has_bits_[0] |= 0x00000004u;
}
inline void WeightedMemoryDataParameter::clear_has_height() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void WeightedMemoryDataParameter::clear_height() {
  height_ = 0u;
  clear_has_height();
}
inline ::google::protobuf::uint32 WeightedMemoryDataParameter::height() const {
  // @@protoc_insertion_point(field_get:caffe.WeightedMemoryDataParameter.height)
  return height_;
}
inline void WeightedMemoryDataParameter::set_height(::google::protobuf::uint32 value) {
  set_has_height();
  height_ = value;
  // @@protoc_insertion_point(field_set:caffe.WeightedMemoryDataParameter.height)
}

// optional uint32 width = 4;
inline bool WeightedMemoryDataParameter::has_width() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void WeightedMemoryDataParameter::set_has_width() {
  _has_bits_[0] |= 0x00000008u;
}
inline void WeightedMemoryDataParameter::clear_has_width() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void WeightedMemoryDataParameter::clear_width() {
  width_ = 0u;
  clear_has_width();
}
inline ::google::protobuf::uint32 WeightedMemoryDataParameter::width() const {
  // @@protoc_insertion_point(field_get:caffe.WeightedMemoryDataParameter.width)
  return width_;
}
inline void WeightedMemoryDataParameter::set_width(::google::protobuf::uint32 value) {
  set_has_width();
  width_ = value;
  // @@protoc_insertion_point(field_set:caffe.WeightedMemoryDataParameter.width)
}

// optional uint32 label_size = 5;
inline bool WeightedMemoryDataParameter::has_label_size() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void WeightedMemoryDataParameter::set_has_label_size() {
  _has_bits_[0] |= 0x00000010u;
}
inline void WeightedMemoryDataParameter::clear_has_label_size() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void WeightedMemoryDataParameter::clear_label_size() {
  label_size_ = 0u;
  clear_has_label_size();
}
inline ::google::protobuf::uint32 WeightedMemoryDataParameter::label_size() const {
  // @@protoc_insertion_point(field_get:caffe.WeightedMemoryDataParameter.label_size)
  return label_size_;
}
inline void WeightedMemoryDataParameter::set_label_size(::google::protobuf::uint32 value) {
  set_has_label_size();
  label_size_ = value;
  // @@protoc_insertion_point(field_set:caffe.WeightedMemoryDataParameter.label_size)
}
