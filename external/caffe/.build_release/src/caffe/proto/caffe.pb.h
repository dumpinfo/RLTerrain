...
class LayerParameter : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_weighted_memory_data_param() const;
  inline void clear_weighted_memory_data_param();
  static const int kWeightedMemoryDataParamFieldNumber = 147;
  inline const ::caffe::WeightedMemoryDataParameter& weighted_memory_data_param() const;
  inline ::caffe::WeightedMemoryDataParameter* mutable_weighted_memory_data_param();
  inline ::caffe::WeightedMemoryDataParameter* release_weighted_memory_data_param();
  inline void set_allocated_weighted_memory_data_param(::caffe::WeightedMemoryDataParameter* weighted_memory_data_param);
...
class WeightedMemoryDataParameter : public ::google::protobuf::Message {
 public:
  ...
  WeightedMemoryDataParameter* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
...
inline ::caffe::WeightedMemoryDataParameter* LayerParameter::mutable_weighted_memory_data_param() {
  ...
  if (weighted_memory_data_param_ == NULL) weighted_memory_data_param_ = new ::caffe::WeightedMemoryDataParameter;
