...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/Release/App_RigidBodyFromObjExampleTinyRenderer
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/App_RigidBodyFromObjExampleTinyRenderer_gmake_x64_release
  ...
  LIBS      += -lBulletInverseDynamics_gmake_x64_release -lBulletDynamics_gmake_x64_release -lBulletCollision_gmake_x64_release -lLinearMath_gmake_x64_release -lBullet3Common_gmake_x64_release -lBulletInverseDynamicsUtils
  LDDEPS    += ../../bin/libBulletInverseDynamics_gmake_x64_release.so ../../bin/libBulletDynamics_gmake_x64_release.so ../../bin/libBulletCollision_gmake_x64_release.so ../../bin/libLinearMath_gmake_x64_release.so ../../bin/libBullet3Common_gmake_x64_release.so
...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/Debug/App_RigidBodyFromObjExampleTinyRenderer
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/App_RigidBodyFromObjExampleTinyRenderer_gmake_x64_debug
  ...
  RESFLAGS  += $(DEFINES) $(INCLUDES) 
  LIBS      += -lBulletInverseDynamics_gmake_x64_debug -lBulletDynamics_gmake_x64_debug -lBulletCollision_gmake_x64_debug -lLinearMath_gmake_x64_debug -lBullet3Common_gmake_x64_debug -lBulletInverseDynamicsUtils
  LDDEPS    += ../../bin/libBulletInverseDynamics_gmake_x64_debug.so ../../bin/libBulletDynamics_gmake_x64_debug.so ../../bin/libBulletCollision_gmake_x64_debug.so ../../bin/libLinearMath_gmake_x64_debug.so ../../bin/libBullet3Common_gmake_x64_debug.so
  LINKCMD    = $(CXX) -o $(TARGET) $(OBJECTS) $(RESOURCES) $(ARCH) $(LIBS) $(LDFLAGS)
  define PREBUILDCMDS
  endef
  define PRELINKCMDS
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking App_RigidBodyFromObjExampleTinyRenderer
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning App_RigidBodyFromObjExampleTinyRenderer
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
